...
class plgFlexicontent_fieldsAddressint extends FCField
{
	...
	function onDisplayField(&$field, &$item)
	{
		...
		$this->values = & $values;     ////////////////  Question: & $values or &$values  /////////////////
	...
	function onBeforeSaveField( &$field, &$post, &$file, &$item )
	{
		...
		// Serialize multi-property data before storing them into the DB, also map some properties as fields ////////// Question: quelle DB? ////////////
